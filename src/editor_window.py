...
class Icons(Enum):
    ...
    UP_ARROW_16_F = r""
    DOWN_ARROW_F = r""
...
class EditorMainApp:
    ...
    def __init__(self, master=None):
        ...
        self.text_script.configure(font=("tkDefaultText", 18, "normal"),
                                   wrap=tk.NONE)
