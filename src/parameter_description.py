...
class ParameterDescription:
    ...
    def __init__(self,
        ...
        self.data = {"load_audio": ("Audio file to load (no extension)",),
                     ...
                     "play_music": ("Music file to play (no extension)", "Loop playback"),
                     ...
                     "character_fade_speed": ("Alias", "Fade direction", "Fade speed (1 to 100)"),
                     ...
                     "dialog_sprite_fade_speed": ("Alias", "Fade direction", "Fade speed (1 to 100)"),
                     ...
                     "object_fade_speed": ("Alias", "Fade direction", "Fade speed (1 to 100)"),
                     ...
                     "sprite_font": ("Sprite type", "Sprite alias", "Font to use"),
