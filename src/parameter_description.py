...
class ParameterDescription:
    ...
    def __init__(self,
        ...
        self.data = {"load_audio": ("Audio name",),
                     ...
                     "character_scale_speed": ("Alias", "Scale speed (1 to 300000)"),
                     ...
                     "dialog_sprite_scale_speed": ("Alias", "Scale speed (1 to 300000)"),
                     ...
                     "object_scale_speed": ("Alias", "Scale speed (1 to 300000)"),
