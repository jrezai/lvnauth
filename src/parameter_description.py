...
class ParameterDescription:
    ...
    def __init__(self,
        ...
        self.data = {"load_audio": ("Audio name",),
                     ...
                     "dialogue_text_sound": ("Audio file", ),
                     ...
                     "character_start_tinting": ("Alias", "Speed (1 to 100)", "Reach tint (0 to 255)", "*(optional) Bright keyword"),
                     "character_focus": ("Alias", ),
                     "character_after_fading_stop": ("Alias", "Reusable script name", "*(optional) Arguments to pass to the reusable script"),
                     "character_fade_current_value": ("Alias", "Opacity (0 to 255)"),
                     "character_start_fading": ("Alias", "Fade speed (1 to 15000)", "Stop at opacity (0 to 255)"),
                     "character_stop_fading": ("Alias",),
                     "character_after_rotating_stop": ("Alias", "Reusable script name", "*(optional) Arguments to pass to the reusable script"),
                     "character_rotate_current_value": ("Alias", "Angle (0 to 359)"),
                     "character_start_rotating": ("Alias", "Rotate direction", "Rotate speed (1 to 220000)", "Stop at angle (0 to 359) or forever"),
                     "character_stop_rotating": ("Alias", ),
                     "character_after_scaling_stop": ("Alias", "Reusable script name", "*(optional) Arguments to pass to the reusable script"),
                     "character_scale_current_value": ("Alias", "Scale value"),
                     "character_start_scaling": ("Alias", "Scale speed (1 to 100000)", "Stop at scale value"),
                     "character_stop_scaling": ("Alias",),
                     "character_after_movement_stop": ("Alias", "Reusable script name", "*(optional) Arguments to pass to the reusable script"),
                     ...
                     "text_dialogue_define": ("Width (pixels)", "Height (pixels)", "Animation speed (1 to 100)", "Intro animation", "Outro animation", "Anchor", "Background color (hex)", "X padding", "Y padding", "Opacity (0 to 255)", "Rounded corners", "Reusable script name to run when intro animation starting", "Reusable script name to run when intro animation finishes", "Reusable script name to run when outro animation starting", "Reusable script name to run when outro animation finishes", "Reusable script name to run when <halt> is used", "Reusable script name to run when the story unhalts after using <halt>", "Border color (hex)", "Border opacity (0 to 255)", "Border thickness"),
                     "halt_auto": ("Number of seconds to halt the dialog",), 
                     "continue": ("(optional) Manual Y position",),
                     
                     "load_dialogue_sprite": ("Dialogue sprite name", "Alias"),
                     "dialogue_sprite_show": ("Sprite name (not alias)", ),
                     "dialogue_sprite_hide": ("Alias", ),
                     "dialogue_sprite_flip_both": ("Alias", ),
                     "dialogue_sprite_flip_horizontal": ("Alias", ),
                     "dialogue_sprite_flip_vertical": ("Alias", ),
                     "dialogue_sprite_start_tinting": ("Alias", "Speed (1 to 100)", "Reach tint (0 to 255)", "*(optional) Bright keyword"),
                     "dialogue_sprite_focus": ("Alias",),
                     "dialogue_sprite_after_fading_stop": ("Alias", "Reusable script name", "*(optional) Arguments to pass to the reusable script"),
                     "dialogue_sprite_fade_current_value": ("Alias", "Opacity (0 to 255)"),
                     "dialogue_sprite_start_fading": ("Alias", "Fade speed (1 to 15000)", "Stop at opacity (0 to 255)"),
                     "dialogue_sprite_stop_fading": ("Alias",),
                     "dialogue_sprite_after_rotating_stop": ("Alias", "Reusable script name", "*(optional) Arguments to pass to the reusable script"),
                     "dialogue_sprite_rotate_current_value": ("Alias", "Angle (0 to 359)"),
                     "dialogue_sprite_start_rotating": ("Alias", "Rotate direction", "Rotate speed (1 to 220000)", "Stop at angle (0 to 359) or forever"),
                     "dialogue_sprite_stop_rotating": ("Alias", ),
                     "dialogue_sprite_after_scaling_stop": ("Alias", "Reusable script name", "*(optional) Arguments to pass to the reusable script"),
                     "dialogue_sprite_scale_current_value": ("Alias", "Scale value"),
                     "dialogue_sprite_start_scaling": ("Alias", "Scale speed (1 to 100000)", "Stop at scale value"),
                     "dialogue_sprite_stop_scaling": ("Alias",),
                     "dialogue_sprite_after_movement_stop": ("Alias", "Reusable script name", "*(optional) Arguments to pass to the reusable script"),
                     
                     "dialogue_sprite_stop_movement_condition": ("Alias", "Side of sprite to check", "Stop location"),
                     ...
                     "dialogue_sprite_set_center": ("Alias", "Center of X (horizontal position)", "Center of Y (vertical position)"),
                     "dialogue_sprite_center_x_with": ("Alias to move", "Sprite type to center with", "Sprite alias to center with"),
                     "dialogue_sprite_on_mouse_click": ("Alias", "Reusable script name", "*(optional) Arguments to pass to the reusable script"),
                     "dialogue_sprite_on_mouse_enter": ("Alias", "Reusable script name", "*(optional) Arguments to pass to the reusable script"),
                     "dialogue_sprite_on_mouse_leave": ("Alias", "Reusable script name", "*(optional) Arguments to pass to the reusable script"),
                     ...
                     "object_start_tinting": ("Alias", "Speed (1 to 100)", "Reach tint (0 to 255)", "*(optional) Bright keyword"),
                     "object_focus": ("Alias",),
                     "object_after_fading_stop": ("Alias", "Reusable script name", "*(optional) Arguments to pass to the reusable script"),
                     "object_fade_current_value": ("Alias", "Opacity (0 to 255)"),
                     "object_start_fading": ("Alias", "Fade speed (1 to 15000)", "Stop at opacity (0 to 255)"),
                     "object_stop_fading": ("Alias",),
                     "object_after_rotating_stop": ("Alias", "Reusable script name", "*(optional) Arguments to pass to the reusable script"),
                     "object_rotate_current_value": ("Alias", "Angle (0 to 359)"),
                     "object_start_rotating": ("Alias", "Rotate direction", "Rotate speed (1 to 220000)", "Stop at angle (0 to 359) or forever"),
                     "object_stop_rotating": ("Alias", ),
                     "object_after_scaling_stop": ("Alias", "Reusable script name", "*(optional) Arguments to pass to the reusable script"),
                     "object_scale_current_value": ("Alias", "Scale value"),
                     "object_start_scaling": ("Alias", "Scale speed (1 to 100000)", "Stop at scale value"),
                     "object_stop_scaling": ("Alias",),
                     "object_after_movement_stop": ("Alias", "Reusable script name", "*(optional) Arguments to pass to the reusable script"),
                     ...
                     "font_text_delay_punc": ("Previous letter", "Number of seconds to delay (0 to 10)"),
                     ...
                     "sprite_font_text_letter_delay": ("Sprite type", "Sprite alias", "Number of seconds to delay (0 to 10)"),
                     "sprite_font_text_delay_punc": ("Sprite type", "Sprite alias", "Previous letter", "Number of seconds to delay (0 to 10)"),
                     ...
                     "list_add": ("List name", "*Single value or comma separated values"),
                     "list_delete": ("List name", ),
                     "list_take_first": ("List name", "Variable name to put value into"),
                     "list_take_last": ("List name", "Variable name to put value into"),
                     "list_take_random": ("List name", "Variable name to put value into"),
                     "list_get_random": ("List name", "Variable name to put value into"),
