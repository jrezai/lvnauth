...
class ParameterDescription:
    ...
    def __init__(self,
        ...
        self.data = {"load_audio": ("Audio name",),
                     ...
                     "character_tint": ("Alias", "Speed (1 to 100)", "Reach tint (0 to 255)", "*(optional) Glow keyword"),
                     ...
                     "dialog_sprite_tint": ("Alias", "Speed (1 to 100)", "Reach tint (0 to 255)", "*(optional) Glow keyword"),
                     ...
                     "object_tint": ("Alias", "Speed (1 to 100)", "Reach tint (0 to 255)", "*(optional) Glow keyword"),
