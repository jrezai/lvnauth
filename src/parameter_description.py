...
class ParameterDescription:
    ...
    def __init__(self,
        ...
        self.data = {
            ...
            "character_start_rotating": (
                "Alias",
                "Rotate direction",
                "Rotate speed (1 to 220000)",
                "Stop at angle (0 to 359) or forever",
            ),
            ...
            "character_start_scaling": (
                "Alias",
                "Scale speed (1 to 100000)",
                "Stop at scale value",
            ),
            ...
            "character_stop_movement_condition": (
                "Alias",
                "Side of sprite to check",
                "Stop location",
            ),
            "character_stop_movement_condition_no_side_to_check": (
                "Alias",
                "Stop location",
            ),
            "character_start_moving": (
                "Alias",
                "Horizontal speed (0 to 1500)",
                "Horizontal direction",
                "Vertical speed (0 to 1500)",
                "Vertical direction",
            ),
            "character_start_moving_to": (
                "Alias",
                "Target X",
                "Target Y",
                "Speed (1 to 3000)",
            ...
            "character_set_center": (
                "Alias",
                "Center of X (horizontal position)",
                "Center of Y (vertical position)",
            ),
            "character_center_x_with": (
                "Alias to move",
                "Sprite type to center with",
                "Sprite alias to center with",
            ),
            ...
            "text_dialogue_define": (
                ...
                "Opacity (0 to 255)",
                "Rounded corners",
                "Reusable script name to run when intro animation starting",
                "Reusable script name to run when intro animation finishes",
                "Reusable script name to run when outro animation starting",
                "Reusable script name to run when outro animation finishes",
                "Reusable script name to run when <halt> is used",
                "Reusable script name to run when the story unhalts after using <halt>",
                "Border color (hex)",
                "Border opacity (0 to 255)",
                "Border thickness",
            ),
            ...
            "dialogue_sprite_start_rotating": (
                "Alias",
                "Rotate direction",
                "Rotate speed (1 to 220000)",
                "Stop at angle (0 to 359) or forever",
            ...
            "dialogue_sprite_stop_movement_condition_no_side_to_check": (
                "Alias",
                "Stop location",
            ),
            "dialogue_sprite_start_moving": (
                "Alias",
                "Horizontal speed (0 to 1500)",
                "Horizontal direction",
                "Vertical speed (0 to 1500)",
            ...
            "dialogue_sprite_start_moving_to": (
                "Alias",
                "Target X",
                "Target Y",
                "Speed (1 to 3000)",
            ...
            "object_stop_movement_condition_no_side_to_check": (
                "Alias",
                "Stop location",
            ),
            "object_start_moving": (
            ...
            "font_text_delay_punc": (
                "Previous letter",
                "Number of seconds to delay (0 to 10)",
            ),
            "font_text_fade_all_speed": ("Fade speed (1 to 10)",),
            "font_text_fade_letter_speed": (
                f"Fade speed (1 to {AnimationSpeed.MAX_CONVENIENT_SPEED_LETTER_BY_LETTER_FADE_IN})",
            ),
            ...
            "sprite_font_y": (
                "Sprite type",
                "Sprite alias",
                "Vertical position value (x)",
            ),
            "sprite_font_text_letter_delay": (
                "Sprite type",
                "Sprite alias",
                "Number of seconds to delay (0 to 10)",
            ),
            "sprite_font_text_delay_punc": (
                "Sprite type",
                "Sprite alias",
                "Previous letter",
                "Number of seconds to delay (0 to 10)",
            ...
            "or_case": (
                ...
                "Comparison operator",
                "Value 2",
                "Condition name to compare with",
            ),
            ...
            "camera_start_shaking": (
                "Intensity (0.01 to 100)",
                "Duration in seconds (0.01 to 100)",
            ),
            "camera_start_moving": (
                "Target X",
                "Target Y",
                "Zoom (0 to 20)",
                "Duration in seconds (0 to 600)",
                "Smoothing style",
            ),
            "camera_stop_moving": ("Stop result",),
            "list_add": ("List name", "*Single value or comma separated values"),
            "list_add_single": ("List name", "Value to add to the list"),
