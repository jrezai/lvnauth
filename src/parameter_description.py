...
class ParameterDescription:
    ...
    def __init__(self,
        ...
        self.data = {"load_audio": ("Audio name",),
                     ...
                     "dialog_sprite_start_tinting": ("Alias", "Speed (1 to 100)", "Reach tint (0 to 255)", "*(optional) Bright keyword"),
                     "dialog_sprite_focus": ("Alias",),
                     ...
                     "dialog_sprite_start_moving": ("Alias", "Horizontal speed (0 to 1500)", "Horizontal direction", "Vertical speed (0 to 1500)", "Vertical direction"),
