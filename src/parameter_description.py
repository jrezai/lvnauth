...
class ParameterDescription:
    ...
    def __init__(self,
        ...
        self.data = {"load_audio": ("Audio name",),
                     ...
                     "character_tint": ("Alias", "Speed (1 to 100)", "Reach tint (0 to 255)", "*(optional) Bright keyword"),
                     ...
                     "character_move": ("Alias", "Horizontal speed (0 to 1500)", "Horizontal direction", "Vertical speed (0 to 1500)", "Vertical direction"),
                     ...
                     "dialog_sprite_tint": ("Alias", "Speed (1 to 100)", "Reach tint (0 to 255)", "*(optional) Bright keyword"),
                     "dialog_sprite_after_fading_stop": ("Alias", "Reusable script name", "*(optional) Arguments to pass to the reusable script"),
                     "dialog_sprite_fade_current_value": ("Alias", "Opacity (0 to 255)"),
                     "dialog_sprite_start_fading": ("Alias", "Fade speed (1 to 15000)", "Stop at opacity (0 to 255)"),
                     "dialog_sprite_stop_fading": ("Alias",),
                     "dialog_sprite_after_rotating_stop": ("Alias", "Reusable script name", "*(optional) Arguments to pass to the reusable script"),
                     "dialog_sprite_rotate_current_value": ("Alias", "Angle (0 to 359)"),
                     "dialog_sprite_start_rotating": ("Alias", "Rotate direction", "Rotate speed (1 to 220000)", "Stop at angle (0 to 359) or forever"),
                     "dialog_sprite_stop_rotating": ("Alias", ),
                     "dialog_sprite_after_scaling_stop": ("Alias", "Reusable script name", "*(optional) Arguments to pass to the reusable script"),
                     "dialog_sprite_scale_current_value": ("Alias", "Scale value"),
                     "dialog_sprite_start_scaling": ("Alias", "Scale speed (1 to 100000)", "Stop at scale value"),
                     "dialog_sprite_stop_scaling": ("Alias",),
                     "dialog_sprite_after_movement_stop": ("Alias", "Reusable script name", "*(optional) Arguments to pass to the reusable script"),
                     ...
                     "dialog_sprite_move": ("Alias", "Horizontal speed (0 to 1500)", "Horizontal direction", "Vertical speed (0 to 1500)", "Vertical direction"),
                     ...
                     "object_tint": ("Alias", "Speed (1 to 100)", "Reach tint (0 to 255)", "*(optional) Bright keyword"),
                     ...
                     "object_move": ("Alias", "Horizontal speed (0 to 1500)", "Horizontal direction", "Vertical speed (0 to 1500)", "Vertical direction"),
